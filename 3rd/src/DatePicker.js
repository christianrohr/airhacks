...
const block0$1 = (context) => { return html`<span class="${ifDefined(classMap(context.classes.frame))}" @focusin="${ifDefined(context.onfocusin)}"><span id="${ifDefined(context._id)}-firstfe" tabindex="0" @focusin=${ifDefined(context.focusHelper.forwardToLast)}></span><div style="${ifDefined(styleMap$1(context.styles.main))}" role="dialog" aria-labelledby="${ifDefined(context.headerId)}" tabindex="-1" class="${ifDefined(classMap(context.classes.main))}">			${ context.hasHeader ? block1(context) : undefined }<div id="${ifDefined(context._id)}-content" role="application" style="${ifDefined(styleMap$1(context.styles.content))}" class="ui5-popup-wrapper-content"><div class="ui5-popup-wrapper-scroll"><slot></slot></div></div>			${ context.hasFooter ? block4() : undefined }<span id="${ifDefined(context._id)}-arrow" style="${ifDefined(styleMap$1(context.styles.arrow))}" class="${ifDefined(classMap(context.classes.arrow))}"></span></div><span id="${ifDefined(context._id)}-lastfe" tabindex="0" @focusin=${ifDefined(context.focusHelper.forwardToFirst)}></span><div tabindex="0" id="${ifDefined(context._id)}-blocklayer" style="${ifDefined(styleMap$1(context.styles.blockLayer))}" class="${ifDefined(classMap(context.classes.blockLayer))}"></div></span>`; };
const block1 = (context) => { return html`<header>			${ context.header.length ? block2(context) : block3(context) }</header>	`; };
const block2 = (context) => { return html`<div role="${ifDefined(context.role)}" class="ui5-popup-wrapper-header"><slot name="header"></slot></div>			`; };
const block3 = (context) => { return html`<h2 role="${ifDefined(context.role)}" class="ui5-popup-wrapper-header ui5-popup-wrapper-headerText">${ifDefined(context.headerText)}</h2>			`; };
...
const block0$2 = (context) => { return html`<button		type="button"		class="${ifDefined(classMap(context.classes.main))}"		?disabled="${ifDefined(context.disabled)}"		data-sap-focus-ref				dir="${ifDefined(context.rtl)}"		@focusout=${ifDefined(context._onfocusout)}		@click=${ifDefined(context._onclick)}		@mousedown=${ifDefined(context._onmousedown)}	>		${ context.icon ? block1$1(context) : undefined }${ context.textContent ? block2$1(context) : undefined }</button>`; };
...
const block0$4 = (context) => { return html`<div class="${ifDefined(classMap(context.classes.wrapper))}" style="${ifDefined(styleMap$1(context.styles.wrapper))}"><div class="${ifDefined(classMap(context.classes.weekNumberContainer))}">		${ repeat(context._weekNumbers, undefined, (item, index) => block1$2(item)) }</div><div id="${ifDefined(context._id)}-content" class="${ifDefined(classMap(context.classes.content))}"><div role="row" class="${ifDefined(classMap(context.classes.weekDaysContainer))}">			${ repeat(context._dayNames, undefined, (item, index) => block2$2(item)) }</div><div id="${ifDefined(context._id)}-days" class="sapWCDayPickerItemsContainer" tabindex="-1">			${ repeat(context._weeks, undefined, (item, index) => block3$1(item)) }</div></div></div>`; };
...
const block3$1 = (item, index, context) => { return html`${ item.length ? block4$1(item) : block6() }`; };
const block4$1 = (item, index, context) => { return html`<div style="display: flex;">						${ repeat(item, undefined, (item, index) => block5(item)) }</div>				`; };
...
const block1$3 = (item, index, context) => { return html`<div class="${ifDefined(classMap(context.classes.quarter))}">			${ repeat(item, undefined, (item, index) => block2$3(item)) }</div>	`; };
...
const block1$4 = (item, index, context) => { return html`<div class="${ifDefined(classMap(context.classes.yearInterval))}">			${ repeat(item, undefined, (item, index) => block2$4(item)) }</div>	`; };
...
const block0$8 = (context) => { return html`<div	class="${ifDefined(classMap(context.classes.main))}"	style="width: 100%;"	?aria-invalid="${ifDefined(context.ariaInvalid)}"	@focusin="${ifDefined(context.onfocusin)}"	@focusout="${ifDefined(context.onfocusout)}"><div id="${ifDefined(context._id)}-wrapper"	class="${ifDefined(classMap(context.classes.wrapper))}">	${ context._beginContent.length ? block1$5() : undefined }<input id="${ifDefined(context._id)}-inner"			class="sapWCInputBaseInner"			type="${ifDefined(context.inputType)}"			?disabled="${ifDefined(context.disabled)}"			?readonly="${ifDefined(context._readonly)}"			.value="${ifDefined(context.value)}"			placeholder="${ifDefined(context.inputPlaceholder)}"			@input="${ifDefined(context._handleInput)}"			@change="${ifDefined(context._handleChange)}"			data-sap-no-tab-ref			data-sap-focus-ref	/>		${ context.icon.length ? block2$5() : undefined }</div>	${ context.showSuggestions ? block3$2(context) : undefined }<slot name="formSupport"></slot></div>`; };
const block1$5 = (context) => { return html`<slot name="_beginContent"></slot>	`; };
const block2$5 = (context) => { return html`<slot name="icon"></slot>		`; };
const block3$2 = (context) => { return html`<ui5-popover				placement-type="Bottom"				no-arrow				horizontal-align="Stretch"				initial-focus="${ifDefined(context._id)}-inner"><ui5-list separators="Inner"><slot></slot></ui5-list></ui5-popover>	`; };
